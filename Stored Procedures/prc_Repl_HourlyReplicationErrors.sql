...
CREATE OR ALTER PROCEDURE dbo.prc_Repl_HourlyReplicationErrors 
   @NotificationEmailAddress VARCHAR(200) = 'alerts@YourDomainNameHere.com', --Insert real distribution list here.
