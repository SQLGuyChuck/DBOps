...
CREATE OR ALTER PROCEDURE dbo.prc_Check_SQLErrorLog
...
**********************************************************************************/
	...
	BEGIN
		...
		SET @subj = 'CMDB - WARNING: prc_Check_SQLErrorLog already running on server' + RTRIM(@@SERVERNAME)
	...
	DROP TABLE #SQLErrorLogContents 
	DROP TABLE #SQLErrorLogListAgent
    RETURN (0) 
END;
GO
