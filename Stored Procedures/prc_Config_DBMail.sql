...
**  2/24/2016	Melanie Labuguen	Changed mail server from YourDomainNameHereopsview to YourDomainNameHereTLSMail1.
**  3/15/2016	Melanie Labuguen	Changed dev mail server from devbuildserver to HQEMail1
******************************************************************************/
SET NOCOUNT ON
