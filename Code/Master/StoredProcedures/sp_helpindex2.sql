...
--                stored procedure: sp_helpindex2ColsInIndexLevels
...
-- http://www.SQLskills.com/blogs/Kimberly (Kimberly L. Tripp)
	...
	begin
		...
		SELECT @inc_Count = @inc_Count + count(*)
        ...
        IF @indid > 1 
            EXEC [sp_helpindex2ColsInIndexLevels] @objid, @indid, @ColsInTree OUTPUT, @ColsInLeaf OUTPUT
